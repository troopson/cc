...
public final class C {
	...
	public static final Logger log = Logger.getLogger("org.pt.Common");
	...
	public static String join( Collection o,String token){
		return StringUtil.joinString(o, token);
	}
	...
	private static Collection doSplit(Collection a,String s,String regx){
		if(StringUtil.isBlank(s) || regx==null)
			return null;
		if(regx.equals("")){
			a.add(s);
			return a;
	...
	public static Date getDate(Map m,String key){
		...
		if(o==null || StringUtil.isBlank(o.toString()))
			...
			return DateUtil.str2Date(o.toString().trim());
	}
	...
	public static String getDateString(Map m,String key){
		...
		if(o==null)
			...
			return DateUtil.date2Str((Date)o);
		else 
			return o.toString();
	}
	...
	public static Object[] getColFromListMap(List<Map> m, String colName){
		if(m==null || m.isEmpty() || StringUtil.isBlank(colName))
			return null;
	...
	public static Map<String, String> buildAttributeMap(String attStr) {
		...
		if (StringUtil.isNotBlank(attStr)) {
			attStr = attStr.trim();
